...
from src.database.db import get_all_students, unenroll_student_to_subject ,  get_student_subjects, get_student_attendance
...
def student_dashboard():
    ...
    with c2:
        st.markdown(
            f"<h3 style='color:#000000;'>Welcome, {student_data['name']}</h3>",
            unsafe_allow_html=True,
        )
